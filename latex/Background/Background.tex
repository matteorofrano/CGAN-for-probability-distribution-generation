...
\begin{itemize}
    ...
    \item \textbf{Volatility range}: $\sigma \in (0.005, 0.8)$
...
\hline
\end{tabular}
\caption{CGAN performance metrics averaged over 1000 samples}
\end{table}
...
\hline
\end{tabular}
\caption{CWGAN-GP performance metrics averaged over 1000 samples}
\end{table}
